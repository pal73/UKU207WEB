			...
			case '0':
				...
				switch (env[2]) {
					case '1':
						...
						len = sprintf((char *)buf,(const char *)&env[4],pal_cyr_coder("Uâûõ, Uâõ, Içàð.ìàêñ., 3ÀÁÂÃÄÅ¨ÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞß1°¹àáâãäå¸æçèéêëìíîïðñòóôõö÷øùüûúýþÿ"));
					break;
			        case '2':
		...
		switch (env[1]) {
			...
			case 'n':
				...
				if(++log_item_cnt>=10)log_item_cnt=0;
          		break;
			case '0':
				len = sprintf((char *)buf,(const char *)&env[3],pal_cyr_coder("10:15:24  26-ñåí-2019><11:17:29  03-îêò-2019><Àâàðèÿ èñòî÷íèêà ¹1:çàâûøåíî âûõîäíîå íàïðÿæåíèå"));
				break;
			case 'e':
